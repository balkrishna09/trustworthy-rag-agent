...
\node[box, fill=black!8, minimum width=3.8cm] (inp)
...
\end{tikzpicture}}
\caption{Processing pipeline of the Evaluation Agent. Color coding: gray denotes input data, blue the three analysis modules, orange the score-fusion step, and green the output verdict.}
\label{fig:arch}
\end{figure}
