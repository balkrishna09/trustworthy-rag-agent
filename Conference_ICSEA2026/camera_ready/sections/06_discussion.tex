...
\textbf{Deployment in the SDLC.} The agent fits as a workflow gate: it can screen a secure-coding knowledge base before indexing and, at $\approx$17\,s per query, act as an asynchronous check in code review or \rev{continuous integration} rather than in the edit loop, with a human reviewing flagged retrievals.
