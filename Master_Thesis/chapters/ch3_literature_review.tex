...
\begin{enumerate}
    \item \textbf{The Trust-Security Gap:} Existing frameworks like RAGAS measure whether the model follows the context, but not if the context is safe. There is a lack of tools that simultaneously evaluate \textit{Factuality} and \textit{Security}.
